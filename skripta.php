<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        <html>
            <head>
                <meta charset="utf-8">
                <meta name="author" content="Bruno Došen">
                <meta name="description" content="Stranica za dijeljenje, novosti i raspravu svega vezanog za knjige">
                <link rel="stylesheet" type="text/css" href="style.css">
                <link rel="icon" type="image/png" href="images/favicon-32x32.png">
                <script src="https://kit.fontawesome.com/89f71c403d.js" crossorigin="anonymous"></script>
                <title>Kula knjiga</title>
            </head>
            <body>
            <div class="wrapper">
                    <header>
